terraform {
  ...
  backend "s3" {
    bucket = "croppilot-terraform-state"
...
resource "aws_elasticache_replication_group" "redis" {
  ...
  description                   = "CropPilot Redis Enterprise"
  ...
  container_definitions = jsonencode([
    {
      ...
      environment = [
        ...
        { name = "POSTGRES_DB", value = "croppilot" },
      ...
      secrets = [
        ...
        { name = "OPENWEATHER_API_KEY", valueFrom = aws_secretsmanager_secret.weather_key.arn },
...
resource "aws_secretsmanager_secret" "weather_key" {
  name       = "${local.name_prefix}-weather-key"
  tags       = local.common_tags
}
